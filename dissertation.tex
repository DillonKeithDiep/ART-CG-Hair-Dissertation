...
\cite{pca1901}
In the original paper by Pearson, PCA takes the ‘best-fitting’ line or plane of a higher dimensional system. Formally, taking $y=a_0+a_1x$, or $z=a_0+a_1x+b_1y$, or $z = a_0+a_1x_1+a_2x_2+a_3x_3+...+a_nx_n$, where $y, x, z, x_1, x_2,...,x_n$ are variables determining the 'best' values for the constants $a_0, a_1,...,a_n$.
PCA works best for reducing dimensions of linear variance.
%\cite{pca2002}

\subsection{Probabilistic Principal Component Analysis}
Tipping and Bishop PPCA determines principal axes of observed data through maximum likelihood estimation of parameters in a latent variable model. Probabilistic approach.
Data has a linear relationship with some latent-space $X_n$. 
