...
\end{equation}
Parameters $\mathbf{W}$ can the nbe found through maximisation of the full data set.
...
A probabilistic intepretation of PCA is the dual PPCA (DPPCA). Linear mappings from the embedded space can easily be non-linearised through Gaussian processes. This is referred to as the GP-LVM.
